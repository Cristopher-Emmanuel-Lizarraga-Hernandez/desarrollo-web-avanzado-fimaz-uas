    ...
    <tbody>
        <?php foreach ($productos as $producto): ?>
            <tr>
                ...
                <td>
                    <a href="index.php?route=productos/edit&id=<?= $producto['id']; ?>" class="btn btn-primary btn-sm">
                        Editar
                    </a>
                    <form action="index.php?route=productos/delete" method="POST" class="d-inline">
                        <input type="hidden" name="id" value="<?= $producto['id']; ?>">
                        <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('¿Deseas eliminar este producto?');">
                            Eliminar
                        </button>
                    </form>
                </td>
